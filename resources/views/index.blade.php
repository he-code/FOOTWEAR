...
@section('navbar')
    <header>
    <a href="#" class="logo">
        <h2 style="color: white" class="imgtamaño">FOOTWEAR</h2>
...
<div class="container_cards">    
    <div class="row_cards">
        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="single-content">
                <img src="{{ asset('img/categoria/cat2.png')}}" alt="">
                <div class="text-content">
                    <h3>CABALLEROS</h3>
                </div>
            </div>
...
<footer class="footer">
    <div class="l-footer">
        ...
        <h2 style="color: white" class="footer_img">FOOTWEAR</h2>
    <p>Venta de calzado y ropa deportiva para damas, caballeros y niños.
    </p>
    </div>
        <ul class="r-footer">
            <li>
        ...
        <div class="b-footer">
            <p>Todos los Derechos reservados by <a href="" target="_blank">©FOOTWEAR-2021</a></p>
        </div>
</footer>
@endsection
@section('title')
        ...
        <div id="contenedor" class="row_p">
            ...
            <div id="verde" class="content_pagos"> 
                ...
                <h5>Primero se envía la cotización al cliente, luego de ello el cliente envía la orden de compra por medio de nuestro correo y a las 24 horas 
                    se le realiza el envío de los productos dentro de San Pablo sin costo alguno, fuera de la cuidad se aplica un adicional.</h5>                   
            </div>
        </div>
    </div>
</div>
