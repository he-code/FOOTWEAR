...
<head>
    ...
    <title>FOOTWEAR |Panel administrativo</title>
    <!-- Scripts -->
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="https://i.ibb.co/Z2shSJj/animado-Recuperado.png" alt="logo" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">FOOTWEAR</span>
                </a>
